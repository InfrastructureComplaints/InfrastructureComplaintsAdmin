...
public class MyAdapterDept extends RecyclerView.Adapter<MyAdapterDept.MyViewHolder> {

    ArrayList<CmpItem> cmps;
    Context context;

    public MyAdapterDept(Context context, ArrayList<CmpItem> cmps) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), ComplaintDept.class);
